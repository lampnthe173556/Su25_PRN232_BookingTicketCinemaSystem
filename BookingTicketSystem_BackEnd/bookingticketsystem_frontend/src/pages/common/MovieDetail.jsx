...
import { Row, Col, Typography, Button, Card, Tag, Rate, List, Input, message, Avatar, Breadcrumb } from "antd";
          ...
          <Col xs={24} md={16}>
            ...
            <div style={{ marginTop: 32 }}>
              ...
              {user ? (
                ...
                <div style={{ marginBottom: 24, padding: 16, backgroundColor: '#fff7e6', border: '1px solid #ffd591', borderRadius: 8 }}>
